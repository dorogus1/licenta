...
function showPage(idx) {
    ...
    navBtns.forEach((b, i) => b.classList.toggle('selected', i === idx));
}
navMain.addEventListener('click', () => showPage(0));
navAccount.addEventListener('click', () => showPage(1));
navApps.addEventListener('click', () => showPage(2));
navDevices.addEventListener('click', () => showPage(3));
showPage(0);
...
// Placeholder: Account, Apps, Devices logic can be added here